...
class VideoLLAMA(Blip2Base):
    ...
    def init_video_Qformer(cls, num_query_token, vision_width,num_hidden_layers =2):
        ...
        encoder_config = BertConfig.from_pretrained("/data1/lch/Video-LLaMA/video_llama/bert-base-uncased/")
    ...
    def __init__(
        ...
        imagebind_ckpt_path = '/data1/lch/Video-LLaMA/ckpt'
    ):
        super().__init__()
    ...
    def from_config(cls, cfg):
        ...
        imagebind_ckpt_path = cfg.get("imagebind_ckpt_path", '/data1/lch/Video-LLaMA/ckpt')
        model = cls(
            vit_model=vit_model,

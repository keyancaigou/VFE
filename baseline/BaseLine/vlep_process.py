...
llama_pr_path="/data1/lch/Video-LLaMA/IJCV/IJCV_Result/velp_pre_videollama_7b_caption.json"
llama_gt_path="/data1/lch/datasets/vlep/vlep_data/vlep_instruct_1k_val.json"
...
save_json(data,'/data1/lch/Video-LLaMA/IJCV/IJCV_Result/result/velp/velp_videollama_7b_caption.json')
    # data.append(line)
